<form class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/bg_image_1.jpg)">
    < class="page-section">
    <div class="container">
        ...
        <form class="main-form" action="{{url('create_appointment')}}" method="post">
            ...
            <div class="row mt-5 ">
                ...
                <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
                    <input type="text" name="nk" class="form-control py-2" placeholder="Neptun kód">
                </div>
                <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
